...
\captionsetup{width=0.9\textwidth}
\centering
\includegraphics[width = 0.9\textwidth]{images/results/convergence_analysis_init_deviation_sim_bar.eps}
...
\captionsetup{width=0.9\textwidth}
\centering
\includegraphics[width = 0.9\textwidth]{images/results/convergence_analysis_init_deviation_real_bar.eps}
...
\captionsetup{width=0.9\textwidth}
\centering
\includegraphics[width = 0.9\textwidth]{images/results/resnorm_ang_pos_dev.eps}
\caption{Residual norm plot for varying position and angle of one actuation unit. The configuration of the other three actuation unit is set to the true value. There are no local minima within the close region to the global minimum.}
