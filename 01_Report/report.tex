...
% TODO Add your title
\title{Estimation of Actuation Configuration for a Multi-Actuated Blimp}
%%\subtitle{bla bla bla (subtitle)}

% TODO Add name of the authors
\studentA{Matthias Krebs}
\studentB{Simon Laube}
% \studentC{Student 3}

% TODO Add name of the supervisors
\supervisionA{Konstantinos Alexis}
\supervisionB{Markus Achtelik}
...
%\cleardoublepage
\input{chapters/design_evaluation}
%\cleardoublepage
\input{chapters/batch_optimization}
%\cleardoublepage
