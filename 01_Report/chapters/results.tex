...
\textbf{solid}: 95\% confidence interval calculated from multiple results. Result is taken from actuation unit number 4. See appendix \cref{fig:result_95pc_confidence_all} for the remaining ones.}
